...
const KATEGORIEN_FIELDS = [
  ...
  { key: 'kategorie_farbe', label: 'Farbe', type: 'lookup/select', options: [{ key: 'blau', label: 'Blau' }, { key: 'gruen', label: 'Grün' }, { key: 'gelb', label: 'Gelb' }, { key: 'orange', label: 'Orange' }, { key: 'lila', label: 'Lila' }, { key: 'grau', label: 'Grau' }, { key: 'rot', label: 'Rot' }] },
];
const NOTIZEN_FIELDS = [
  { key: 'notiz_titel', label: 'Titel', type: 'string/text' },
  { key: 'notiz_inhalt', label: 'Inhalt', type: 'string/textarea' },
  { key: 'notiz_kategorie', label: 'Kategorie', type: 'applookup/select', targetEntity: 'kategorien', targetAppId: 'KATEGORIEN', displayField: 'kategorie_name' },
  { key: 'notiz_datum', label: 'Datum', type: 'date/date' },
  { key: 'notiz_prioritaet', label: 'Priorität', type: 'lookup/radio', options: [{ key: 'niedrig', label: 'Niedrig' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
  { key: 'notiz_status', label: 'Status', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'erledigt', label: 'Erledigt' }] },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'notizen' && fieldKey === 'notiz_kategorie') {
